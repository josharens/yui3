import _series_combospline_stacked from './series-combospline-stacked.mjs';
import _series_combo_stacked from './series-combo-stacked.mjs';
import _series_areaspline_stacked from './series-areaspline-stacked.mjs';
import _series_bar_stacked from './series-bar-stacked.mjs';
import _series_column_stacked from './series-column-stacked.mjs';
import _series_spline_stacked from './series-spline-stacked.mjs';
import _series_area_stacked from './series-area-stacked.mjs';
import _series_marker_stacked from './series-marker-stacked.mjs';
import _series_line_stacked from './series-line-stacked.mjs';
import _series_combospline from './series-combospline.mjs';
import _series_combo from './series-combo.mjs';
import _series_areaspline from './series-areaspline.mjs';
import _series_bar from './series-bar.mjs';
import _series_column from './series-column.mjs';
import _series_spline from './series-spline.mjs';
import _series_area from './series-area.mjs';
import _series_marker from './series-marker.mjs';
import _series_line from './series-line.mjs';
import _series_pie from './series-pie.mjs';
import _axes from './axes.mjs';
import _graphics_group from './graphics-group.mjs';
import _event_touch from './event-touch.mjs';
import _event_mouseenter from './event-mouseenter.mjs';
import _dom from './dom.mjs';

export default {
  name: 'charts-base',
  load: _load_module_charts_base,
};
  
function _load_module_charts_base(Y, NAME) {

	Y.use(_dom);
	Y.use(_event_mouseenter);
	Y.use(_event_touch);
	Y.use(_graphics_group);
	Y.use(_axes);
	Y.use(_series_pie);
	Y.use(_series_line);
	Y.use(_series_marker);
	Y.use(_series_area);
	Y.use(_series_spline);
	Y.use(_series_column);
	Y.use(_series_bar);
	Y.use(_series_areaspline);
	Y.use(_series_combo);
	Y.use(_series_combospline);
	Y.use(_series_line_stacked);
	Y.use(_series_marker_stacked);
	Y.use(_series_area_stacked);
	Y.use(_series_spline_stacked);
	Y.use(_series_column_stacked);
	Y.use(_series_bar_stacked);
	Y.use(_series_areaspline_stacked);
	Y.use(_series_combo_stacked);
	Y.use(_series_combospline_stacked);
