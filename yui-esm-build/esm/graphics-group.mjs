...
export default {
  name: 'graphics-group',
  load: _load_module_graphics_group,
};
  
function _load_module_graphics_group(Y, NAME) {

	Y.use(_graphics);

	/** source: ShapeGroup.js */
