...
import _graphics from './graphics.mjs';

export default {
  name: 'graphics-canvas',
  load: _load_module_graphics_canvas,
};
  
function _load_module_graphics_canvas(Y, NAME) {

	Y.use(_graphics);
	Y.use(_color_base);

	/** source: CanvasDrawing.js */
