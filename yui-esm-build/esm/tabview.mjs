...
import _widget_child from './widget-child.mjs';
import _widget_parent from './widget-parent.mjs';
import _widget from './widget.mjs';

export default {
  name: 'tabview',
  load: _load_module_tabview,
};
  
function _load_module_tabview(Y, NAME) {

	Y.use(_widget);
	Y.use(_widget_parent);
	Y.use(_widget_child);
	Y.use(_tabview_base);
