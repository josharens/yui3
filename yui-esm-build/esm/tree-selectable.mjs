import _tree from './tree.mjs';

export default {
  name: 'tree-selectable',
  load: _load_module_tree_selectable,
};
  
function _load_module_tree_selectable(Y, NAME) {

	Y.use(_tree);

	/** source: tree-selectable.js */
...
Y.Tree.Selectable = Selectable;
	...
	/** source: tree-node-selectable.js */
