...
import _event_custom from './event-custom.mjs';
import _event_simulate from './event-simulate.mjs';

export default {
  name: 'test',
  load: _load_module_test,
};
  
function _load_module_test(Y, NAME) {

	Y.use(_event_simulate);
	Y.use(_event_custom);
