...
import _datatype_date_math from './datatype-date-math.mjs';
import _datatype_date from './datatype-date.mjs';
import _widget from './widget.mjs';

export default {
  name: 'calendar-base',
  load: _load_module_calendar_base,
};
  
function _load_module_calendar_base(Y, NAME) {

	Y.use(_widget);
	Y.use(_datatype_date);
	Y.use(_datatype_date_math);
	Y.use(_cssgrids);

	/** source: calendar-base.js */
