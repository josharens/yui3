...
export default {
  ...
  load: _load_module_autocomplete_highlighters_accentfold,
};
  
function _load_module_autocomplete_highlighters_accentfold(Y, NAME) {

	Y.use(_array_extras);
	Y.use(_highlight_accentfold);

	/** source: autocomplete-highlighters-accentfold.js */
