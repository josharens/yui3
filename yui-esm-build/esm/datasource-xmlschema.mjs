...
import _datatype_xml from './datatype-xml.mjs';
import _plugin from './plugin.mjs';
import _datasource_local from './datasource-local.mjs';

export default {
  name: 'datasource-xmlschema',
  load: _load_module_datasource_xmlschema,
};
  
function _load_module_datasource_xmlschema(Y, NAME) {
	...
	/** source: datasource-xmlschema.js */
