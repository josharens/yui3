...
import _datatype_date from './datatype-date.mjs';
import _datatype_number from './datatype-number.mjs';
import _classnamemanager from './classnamemanager.mjs';

export default {
  name: 'axis-base',
  load: _load_module_axis_base,
};
  
function _load_module_axis_base(Y, NAME) {

	Y.use(_classnamemanager);
	Y.use(_datatype_number);
	Y.use(_datatype_date);
	Y.use(_base);
	Y.use(_event_custom);
