import _text_data_wordbreak from './text-data-wordbreak.mjs';
import _array_extras from './array-extras.mjs';

export default {
  name: 'text-wordbreak',
  load: _load_module_text_wordbreak,
};
  
function _load_module_text_wordbreak(Y, NAME) {

	Y.use(_array_extras);
	Y.use(_text_data_wordbreak);

	/** source: text-wordbreak.js */
