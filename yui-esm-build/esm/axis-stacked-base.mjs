import _axis_numeric_base from './axis-numeric-base.mjs';

export default {
  name: 'axis-stacked-base',
  load: _load_module_axis_stacked_base,
};
  
function _load_module_axis_stacked_base(Y, NAME) {

	Y.use(_axis_numeric_base);

	/** source: StackedImpl.js */
