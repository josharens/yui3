import _editor_para_base from './editor-para-base.mjs';

export default {
  name: 'editor-para-ie',
  load: _load_module_editor_para_ie,
};
  
function _load_module_editor_para_ie(Y, NAME) {

	Y.use(_editor_para_base);

	/** source: editor-para-ie.js */
