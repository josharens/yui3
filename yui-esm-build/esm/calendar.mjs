import _calendarnavigator from './calendarnavigator.mjs';
import _calendar_base from './calendar-base.mjs';

export default {
  name: 'calendar',
  load: _load_module_calendar,
};
  
function _load_module_calendar(Y, NAME) {

	Y.use(_calendar_base);
	Y.use(_calendarnavigator);
