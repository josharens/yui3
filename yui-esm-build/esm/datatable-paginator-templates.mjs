import _template from './template.mjs';

export default {
  name: 'datatable-paginator-templates',
  load: _load_module_datatable_paginator_templates,
};
  
function _load_module_datatable_paginator_templates(Y, NAME) {

	Y.use(_template);

	/** source: paginator-templates.js */
