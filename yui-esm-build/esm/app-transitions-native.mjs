import _transition from './transition.mjs';
import _parallel from './parallel.mjs';
import _app_transitions_css from './app-transitions-css.mjs';
import _app_transitions from './app-transitions.mjs';

export default {
  name: 'app-transitions-native',
  load: _load_module_app_transitions_native,
};
  
function _load_module_app_transitions_native(Y, NAME) {

	Y.use(_app_transitions);
	Y.use(_app_transitions_css);
	Y.use(_parallel);
	Y.use(_transition);

	/** source: app-transitions-native.js */
