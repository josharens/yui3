import _axis_category_base from './axis-category-base.mjs';
import _axis from './axis.mjs';

export default {
  name: 'axis-category',
  load: _load_module_axis_category,
};
  
function _load_module_axis_category(Y, NAME) {

	Y.use(_axis);
	Y.use(_axis_category_base);

	/** source: CategoryAxis.js */
