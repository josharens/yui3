import _uploader_queue from './uploader-queue.mjs';
import _event_custom from './event-custom.mjs';
import _node from './node.mjs';
import _cssbutton from './cssbutton.mjs';
import _base from './base.mjs';
import _widget from './widget.mjs';
import _escape from './escape.mjs';
import _swfdetect from './swfdetect.mjs';

export default {
  name: 'uploader-flash',
  load: _load_module_uploader_flash,
};
  
function _load_module_uploader_flash(Y, NAME) {
