...
import _event_gestures from './event-gestures.mjs';
import _widget from './widget.mjs';

export default {
  name: 'scrollview-base',
  load: _load_module_scrollview_base,
};
  
function _load_module_scrollview_base(Y, NAME) {

	Y.use(_widget);
	Y.use(_event_gestures);
	Y.use(_event_mousewheel);
	Y.use(_transition);

	/** source: scrollview-base.js */
