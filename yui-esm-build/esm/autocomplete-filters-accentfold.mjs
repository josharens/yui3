...
export default {
  ...
  load: _load_module_autocomplete_filters_accentfold,
};
  
function _load_module_autocomplete_filters_accentfold(Y, NAME) {

	Y.use(_array_extras);
	Y.use(_text_accentfold);
	Y.use(_text_wordbreak);

	/** source: autocomplete-filters-accentfold.js */
