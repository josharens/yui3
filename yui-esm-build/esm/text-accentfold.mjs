import _text_data_accentfold from './text-data-accentfold.mjs';
import _array_extras from './array-extras.mjs';

export default {
  name: 'text-accentfold',
  load: _load_module_text_accentfold,
};
  
function _load_module_text_accentfold(Y, NAME) {

	Y.use(_array_extras);
	Y.use(_text_data_accentfold);

	/** source: text-accentfold.js */
