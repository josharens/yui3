import _querystring_stringify_simple from './querystring-stringify-simple.mjs';
import _event_custom_base from './event-custom-base.mjs';

export default {
  name: 'io-base',
  load: _load_module_io_base,
};
  
function _load_module_io_base(Y, NAME) {

	Y.use(_event_custom_base);
	Y.use(_querystring_stringify_simple);
