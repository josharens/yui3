...
import _stylesheet from './stylesheet.mjs';
import _editor_selection from './editor-selection.mjs';
import _node_base from './node-base.mjs';

export default {
  name: 'content-editable',
  load: _load_module_content_editable,
};
  
function _load_module_content_editable(Y, NAME) {
        ...
        */
        render: function(node) {
            ...
            fn = Y.bind(function() {
                ...
                inst.use(_node_base, Y.bind(this._instanceLoaded, this));
            }, this);
