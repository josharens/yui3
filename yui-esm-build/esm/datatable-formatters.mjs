...
import _datatype_date_format from './datatype-date-format.mjs';
import _datatype_number_format from './datatype-number-format.mjs';
import _datatable_body from './datatable-body.mjs';

export default {
  name: 'datatable-formatters',
  load: _load_module_datatable_formatters,
};
  
function _load_module_datatable_formatters(Y, NAME) {

	Y.use(_datatable_body);
	Y.use(_datatype_number_format);
	Y.use(_datatype_date_format);
	Y.use(_escape);

	/** source: formatters.js */
