import _series_histogram_base from './series-histogram-base.mjs';
import _series_marker from './series-marker.mjs';

export default {
  name: 'series-column',
  load: _load_module_series_column,
};
  
function _load_module_series_column(Y, NAME) {

	Y.use(_series_marker);
	Y.use(_series_histogram_base);

	/** source: ColumnSeries.js */
