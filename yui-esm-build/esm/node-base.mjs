...
import _node_core from './node-core.mjs';
import _event_base from './event-base.mjs';

export default {
  name: 'node-base',
  load: _load_module_node_base,
};
  
function _load_module_node_base(Y, NAME) {
