import _uploader_flash from './uploader-flash.mjs';
import _uploader_html5 from './uploader-html5.mjs';

export default {
  name: 'uploader',
  load: _load_module_uploader,
};
  
function _load_module_uploader(Y, NAME) {

	Y.use(_uploader_html5);
	Y.use(_uploader_flash);
