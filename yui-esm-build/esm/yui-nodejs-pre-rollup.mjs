...
export default {
  name: 'yui-nodejs-pre-rollup',
  load: _load_module_yui_nodejs_pre_rollup,
};
...
**/
    ...
    /*global YUI*/
    /*global YUI_config*/
    var YUI = globalThis.YUI = function() {
        var i = 0,
            Y = this,
            args = arguments,
            l = args.length,
...
function _load_module_yui_nodejs_pre_rollup(Y, NAME) {
