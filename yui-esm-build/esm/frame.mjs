import _node_base from "./node_base.mjs";
import _yui_throttle from './yui-throttle.mjs';
import _selector_css3 from './selector-css3.mjs';
...
export default {
  name: 'frame',
  load: _load_module_frame,
};

function _load_module_frame(Y, NAME) {

	Y.use(_base);
	Y.use(_node);
	Y.use(_plugin);
	Y.use(_selector_css3);
	Y.use(_yui_throttle);
