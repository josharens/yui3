import _node_focusmanager from './node-focusmanager.mjs';
...
export default {
  name: 'node-menunav',
  load: _load_module_node_menunav,
};
  
function _load_module_node_menunav(Y, NAME) {

	Y.use(_node);
	Y.use(_classnamemanager);
	Y.use(_plugin);
	Y.use(_node_focusmanager);

	/** source: node-menunav.js */
