...
import _console_filters from './console-filters.mjs';

export default {
  name: 'test-console',
  load: _load_module_test_console,
};
  
function _load_module_test_console(Y, NAME) {

	Y.use(_console_filters);
	Y.use(_test);
	Y.use(_array_extras);

	/** source: test-console.js */
