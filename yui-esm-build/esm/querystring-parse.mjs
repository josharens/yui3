...
export default {
  ...
  load: _load_module_querystring_parse,
};
  
function _load_module_querystring_parse(Y, NAME) {

	Y.use(_yui_base);
	Y.use(_array_extras);

	/** source: querystring-parse.js */
...
mergeParams = function(params, addition) {
    return (
        ...
        ((!params) ? // if the existing value is an array, then concat it.
        addition : (Y.Lang.isArray(params)) ? params.concat(addition)
