...
import _button_plugin from './button-plugin.mjs';

export default {
  name: 'widget-buttons',
  load: _load_module_widget_buttons,
};
  
function _load_module_widget_buttons(Y, NAME) {

	Y.use(_button_plugin);
	Y.use(_cssbutton);
	Y.use(_widget_stdmod);

	/** source: widget-buttons.js */
