...
export default {
  name: 'graphics-svg',
  load: _load_module_graphics_svg,
};
  
function _load_module_graphics_svg(Y, NAME) {

	Y.use(_graphics);

	/** source: SVGDrawing.js */
