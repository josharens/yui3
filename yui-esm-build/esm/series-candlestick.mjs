import _series_range from './series-range.mjs';

export default {
  name: 'series-candlestick',
  load: _load_module_series_candlestick,
};
  
function _load_module_series_candlestick(Y, NAME) {

	Y.use(_series_range);

	/** source: CandlestickSeries.js */
