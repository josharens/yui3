import _datatable_paginator_templates from './datatable-paginator-templates.mjs';
import _datatable_foot from './datatable-foot.mjs';
import _paginator_core from './paginator-core.mjs';
import _view from './view.mjs';
import _model from './model.mjs';

export default {
  name: 'datatable-paginator',
  load: _load_module_datatable_paginator,
};
  
function _load_module_datatable_paginator(Y, NAME) {

	Y.use(_model);
	Y.use(_view);
	Y.use(_paginator_core);
	Y.use(_datatable_foot);
	Y.use(_datatable_paginator_templates);
