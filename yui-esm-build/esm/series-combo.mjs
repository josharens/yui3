import _series_fill_util from './series-fill-util.mjs';
import _series_plot_util from './series-plot-util.mjs';
import _series_line_util from './series-line-util.mjs';
import _series_cartesian from './series-cartesian.mjs';

export default {
  name: 'series-combo',
  load: _load_module_series_combo,
};
  
function _load_module_series_combo(Y, NAME) {

	Y.use(_series_cartesian);
	Y.use(_series_line_util);
	Y.use(_series_plot_util);
	Y.use(_series_fill_util);

	/** source: ComboSeries.js */
