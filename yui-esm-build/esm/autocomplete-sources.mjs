...
import _jsonp from './jsonp.mjs';
import _json_parse from './json-parse.mjs';
import _io_base from './io-base.mjs';

export default {
  name: 'autocomplete-sources',
  load: _load_module_autocomplete_sources,
};
  
function _load_module_autocomplete_sources(Y, NAME) {
	...
	/** source: autocomplete-sources.js */
    ...
    **/
    _createIOSource: function (source) {
        ...
        ioSource.sendRequest = function (request) {
            ...
            // the future.
            Y.use(_io_base, _json_parse, function () {
