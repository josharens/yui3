...
export default {
  name: 'graphics-vml',
  load: _load_module_graphics_vml,
};
  
function _load_module_graphics_vml(Y, NAME) {

	Y.use(_graphics);
	Y.use(_color_base);

	/** source: VMLDrawing.js */
