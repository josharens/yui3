...
export default {
  name: 'loader-pathogen-combohandler',
  load: _load_module_loader_pathogen_combohandler,
};
  
function _load_module_loader_pathogen_combohandler(Y, NAME) {


	/** source: loader-pathogen-combohandler.js */
