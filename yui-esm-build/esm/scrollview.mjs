import _scrollview_scrollbars from './scrollview-scrollbars.mjs';
import _scrollview_base from './scrollview-base.mjs';

export default {
  name: 'scrollview',
  load: _load_module_scrollview,
};
  
function _load_module_scrollview(Y, NAME) {

	Y.use(_scrollview_base);
	Y.use(_scrollview_scrollbars);
