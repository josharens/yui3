...
import _widget_modality from './widget-modality.mjs';
import _widget_buttons from './widget-buttons.mjs';
import _widget_autohide from './widget-autohide.mjs';
import _widget from './widget.mjs';

export default {
  name: 'panel',
  load: _load_module_panel,
};
  
function _load_module_panel(Y, NAME) {

	Y.use(_widget);
	Y.use(_widget_autohide);
	Y.use(_widget_buttons);
	Y.use(_widget_modality);
